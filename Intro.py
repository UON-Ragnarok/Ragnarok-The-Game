...
class Intro:
    ...
    def about(self):
        ...
        self.draw_text(25, WHITE, "Use mouse or trackpad to control", (170, 75))
        self.draw_text(25, WHITE, "the spaceship and destroy Asgard", (170, 95))
        self.draw_img(self.IMGS["mob_img"], self.ss_top_left_x, self.ss_top_left_y + 25 + self.ss_height)
        self.draw_text(25, WHITE, "Sworn protectors of Asgard,", (170, 175))
        self.draw_text(25, WHITE, "destroy them to earn points", (170, 195))
        self.draw_img(self.IMGS["meteor_img"], self.ss_top_left_x - 10, self.ss_top_left_y + 25 + self.ss_height + 25 + self.mo_height)
        self.draw_text(25, WHITE, "Meteorites are indestructable,", (170, 290))
        self.draw_text(25, WHITE, "avoid them at all cost", (170, 310))
        ...
        self.draw_text(25, WHITE, "Collect to gain awesome powers", (170, 410))
        self.draw_img(self.IMGS["thor_img"], self.ss_top_left_x - 40, self.ss_top_left_y + 25 + self.ss_height + 25 + self.mo_height + 25 + self.mt_height + 25 + self.pw_height)
        self.draw_text(60, WHITE, "???", (190, 590))
