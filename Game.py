...
class Game:
    def __init__(self):
        ...
        self.is_mute = False
        # variable to allow looping background
        self.background_y = 0
    ...
    # Making masks for images for collisions
    def init_masks(self):
    ...
    def update(self):
        ...
        if self.alive and not self.pause:
            # Detect player colliding (prefect pixel collision) with enemy
           ...
           # Spawning mobs
            ...
            for sprite in self.sprites_list :
                # If objects go off screen, remove them
        ...
        elif self.pause: # On pausing
            self.show_menu('b') # Show pause screen

        elif not self.pause and self.countdown: # On unpausing
